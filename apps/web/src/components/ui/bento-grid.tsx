...
/**
 * magicui bento-grid, restyled to the app register: cards here carry
 * full-bleed video/artwork backgrounds (not the pale washes the upstream
 * neutral text palette assumes), so name/description are fixed white-on-tint
 * and the card border is the shared `glass-edge` hairline instead of
 * white/10.
 */
const BentoCard = ({
	name,
