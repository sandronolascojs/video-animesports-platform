...
/**
 * Route-loading for `/projects` — SSR navigation only (client-side
 * page/filter changes are handled inside `ProjectsView` itself via
			...
			<div className="flex shrink-0 flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
				<div className="min-w-0">
					...
					<p className="mt-1 text-muted-foreground text-sm">
						Every episode you've started — open one to keep directing.
					</p>
				</div>
